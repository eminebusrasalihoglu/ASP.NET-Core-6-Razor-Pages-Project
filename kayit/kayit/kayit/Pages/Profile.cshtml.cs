...
namespace kayit.Pages
{
    ...
    public class ProfileModel : PageModel
    {
        ...
        public ProfileModel(ILogger<IndexModel> logger, Microsoft.AspNetCore.Identity.UserManager<IdentityUser> userManager, JsonProfilService JsonProfilService, IFileUploadService fileUploadService)
        {
            _logger = logger;
        ...
        public void OnGet()
        {
            Projects = jsonProfilService.GetProfile(Func());
        }
